...
namespace Doozy.Runtime.UIManager.Containers
{
    public partial class UIView
    {
        ...
        public static IEnumerable<UIView> GetViews(UIViewId.Skip id) => GetViews(nameof(UIViewId.Skip), id.ToString());
        public static void Show(UIViewId.Skip id, bool instant = false) => Show(nameof(UIViewId.Skip), id.ToString(), instant);
        public static void Hide(UIViewId.Skip id, bool instant = false) => Hide(nameof(UIViewId.Skip), id.ToString(), instant);
